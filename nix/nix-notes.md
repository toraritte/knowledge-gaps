...
See [`elixir-phoenix-postgres/` directory](https://github.com/toraritte/shell.nixes/tree/master/elixir-phoenix-postgres) in [`shell.nixes` repo](https://github.com/toraritte/shell.nixes).
